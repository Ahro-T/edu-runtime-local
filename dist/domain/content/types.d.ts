...
export type NodeType = 'concept' | 'skill' | 'principle' | 'pattern' | 'tool' | 'workflow';
export type RelationType = 'prerequisite-of' | 'related-to' | 'example-of' | 'implemented-by' | 'compared-with';
