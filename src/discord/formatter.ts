 ...
 */
export function formatNodeExplanation(node: KnowledgeNode): string {
  const lines: string[] = [];
 ...
 */
export function formatTaskPrompt(node: KnowledgeNode, instructions: string): string {
  const lines: string[] = [];
 ...
 */
export function formatEvaluation(result: EvaluationResult, nodeTitle: string): string {
  const lines: string[] = [];
 ...
 */
export function formatAdvancement(result: AdvancementResult): string {
 ...
 */
export function formatReviewScheduled(nodeId: string, scheduledFor: Date): string {
  return [
