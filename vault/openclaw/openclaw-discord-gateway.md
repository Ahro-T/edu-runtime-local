...
### Relation to Runtime
The gateway is a plugin that registers with the runtime on startup. It uses the runtime's HTTP API surface — it does not access the database or agent logic directly.
